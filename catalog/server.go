// Defines a gRPC server (grpcServer) that implements the methods defined in the .proto file

package catalog

import (
	"Microservices-based-E-commerce-System/catalog/pb"
	"context"
	"fmt"
	"log"
	"net"
...
// Route to different service methods based on input
// If query is provided, it's a search
// If specific product IDs are provided, fetch those
// Otherwise, return all or paginated products
